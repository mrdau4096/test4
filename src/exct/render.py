...
def PROCESS_OBJECT(OBJECT_DATA, PLAYER, COPIED_VERTS, COPIED_INDICES):
	...
	if OBJECT_TYPE in [SPRITE_STATIC, ITEM, ENEMY]:
		...
		COPIED_VERTS, COPIED_INDICES = OBJECT_VAO_MANAGER(OBJECT_TYPE, OBJECT_DATA.NORMALS, COORDINATES, OBJECT_DATA.TEXTURE_INFO[0], [COPIED_VERTS, COPIED_INDICES])
...
def OBJECT_VAO_MANAGER(CLASS_TYPE, NORMALS, POINTS, TEXTURE_DATA, VAO_DATA):
	...
	elif CLASS_TYPE in (QUAD, SPRITE_STATIC, ITEM, INTERACTABLE, ENEMY): #Quads
		FACE_ORDER = (0, 1, 2, 3)
