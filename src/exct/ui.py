...
global IMAGE_CACHE, UI_SURFACE #For caching of images, so they are not loaded multiple times. Also UI_SURFACE for all UI drawing.
...
def HUD(PLAYER, FPS):
	...
	try:
		...
		DRAW_IMG(UI_SURFACE, "ENERGY", (5, 322), (94, 16))
		DRAW_IMG(UI_SURFACE, "HEALTH", (5, 343), (88, 16))
...
def MAIN_MENU(DEFAULT_DATA, OPTIONS_DATA):
	...
	DRAW_IMG(UI_SURFACE, "menu_text", (275, 20), (360, 144))
