...
def HUD(PLAYER, FPS):
	...
	SCALED_UI_SURFACE = PG.transform.scale(UI_SURFACE, CONSTANTS["DISPLAY_RESOLUTION"].TO_LIST())

	UI_SURFACE_ID = SURFACE_TO_TEXTURE(SCALED_UI_SURFACE)
...
def SURFACE_TO_TEXTURE(UI_SURFACE):
	NEW_SCALE = CONSTANTS["DISPLAY_RESOLUTION"].TO_INT()
