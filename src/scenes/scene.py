			...
			if LINE[0].strip() == ">":
				...
				if CLASS_TYPE == SCENE:
					...
					if CLASS_TYPE == CUBE_STATIC:
						...
						FINALISED_OBJECT = SPRITE_STATIC(CURRENT_ID, CENTRE, DIMENTIONS, OBJECT_DATA[2], TEXTURE_DATA)

					if TEXTURE_DATA != [] and CLASS_TYPE not in [SPRITE_STATIC,]:
						ENV_VAO_DATA = render.OBJECT_VAO_MANAGER(CLASS_TYPE, POINTS, TEXTURE_DATA[0], ENV_VAO_DATA)
